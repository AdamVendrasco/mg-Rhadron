...
# with command line options: Configuration/GenProduction/python/mg-Rhadron_mGl-1800-fragment.py --python_filename ../gen-output-configs/mg-Rhadron_mGl-1800-CMSSW_12_4_8-n100-1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:../gen-output-files/mg-Rhadron_mGl-1800-CMSSW_12_4_8-n100.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/mg-Rhadron_mGl-1800-fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:../gen-output-files/mg-Rhadron_mGl-1800-CMSSW_12_4_8-n100.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:../gen-output-files/mg-Rhadron_mGl-1800-CMSSW_12_4_8-n100_inLHE.root'),
